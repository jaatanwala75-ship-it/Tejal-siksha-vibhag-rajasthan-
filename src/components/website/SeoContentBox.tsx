...
const contentEn = [
  { type: 'h1', text: 'Tejal Siksha Vibhag – Latest Government Jobs, Results & Notifications 2026' },
  { type: 'p', text: 'Tejal Siksha Vibhag is a trusted informational website in India where you can find the latest government jobs, admit cards, exam dates, results, answer keys, and official notifications — all in one place.\nWe publish new updates daily so that candidates receive every important piece of information on time. All information provided here is sourced from verified public sources and official websites.\nIf you are preparing for a government job in 2026, Tejal Siksha Vibhag is your complete information platform.' },
  { type: 'h1', text: 'Tejal Siksha Vibhag – Government Job Updates in One Place' },
  { type: 'p', text: 'Every year, lakhs of students and job seekers search online for government job updates. The purpose of Tejal Siksha Vibhag is to provide you with information about all central and state government recruitments in one place.\nHere you get:\n• Latest Government Job Notifications\n• Exam Date Updates\n• Admit Card Alerts\n• Sarkari Results\n• Merit List & Cut Off Marks\n• Answer Key & Syllabus Details\nWe ensure that no important update is missed by you.' },
  ...
  { type: 'h1', text: 'Tejal Siksha Vibhag 2026 – 2027' },
...
const contentHi = [
  ...
  { type: 'h1', text: 'तेजल शिक्षा विभाग 2026 – 2027' },
